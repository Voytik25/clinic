...
const swiperH = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"]('.hero__swiper', {
  slidesPerView: 1
});
const swiperW = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"]('.workers__swiper', {
  slidesPerView: 3,
  spaceBetween: 20,
  navigation: {
    nextEl: '.workers__slider-btn--next',
    prevEl: '.workers__slider-btn--prev'
  }
});
const swiperS = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"]('.stock__swiper', {
  slidesPerView: 'auto',
  spaceBetween: 20,
  navigation: {
    nextEl: '.stock__slider-btn--next',
    prevEl: '.stock__slider-btn--prev'
  }
});
const swiperJ = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"]('.injection__swiper', {
  slidesPerView: 3,
  spaceBetween: 20,
  navigation: {
    nextEl: '.injection__slider-btn--next',
    prevEl: '.injection__slider-btn--prev'
  }
});
